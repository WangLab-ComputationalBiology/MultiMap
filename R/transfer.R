...
#'
#' @param anchorsetL An \code{\link{AnchorSet}} object list generated by
...
#' the query.
#' @param assay An \code{Assay} object
#' @param integration.name Integration slot name
...
#'
#' @return If \code{query} is provided, a modified query object is returned. For
...
#' @export
#'
TransferData_MB <- function(anchorsetL,
                            refdata,
                            reference = NULL,
                            query = NULL,
                            features = NULL,
